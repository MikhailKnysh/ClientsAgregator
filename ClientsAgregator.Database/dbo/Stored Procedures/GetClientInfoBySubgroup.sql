...
JOIN [ClientsAgregatorDB].[Products] ON [ClientsAgregatorDB].[Products].[Id] = [ClientsAgregatorDB].[Product_Order].[ProductId]
JOIN [ClientsAgregatorDB].[Product_Subgroup] ON [ClientsAgregatorDB].[Product_Subgroup].ProductId = [ClientsAgregatorDB].[Products].[Id]
